...
- A potential point about the R0: we might expect lower apparent R0 at higher spatial scales since we’re summing a bunch of epidemic curves that take place over a long timespan – lots of the curves we add will be zeros. 
