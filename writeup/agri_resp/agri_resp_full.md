...
For the baseline assortativity, we used $\eta = 0.67$, reflecting moderate assortativity where agricultural workers have preferential within-group contact but still interact with the general population. At this baseline, agricultural workers have approximately 67% of their between-household contacts within their own group and 33% with the general community (range across regions: 67.2%–67.7% within-group). The general community, being much larger, has nearly all contacts (>99%) within their own group. In sensitivity analyses, we considered $\eta \in \{0, 1/4, 1/3, 1/2, 3/4\}$, corresponding to agricultural workers having 0%, 25%, 33%, 50%, and 75% of contacts within their own group, respectively.
