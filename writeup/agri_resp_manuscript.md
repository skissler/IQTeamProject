...
Respiratory disease outbreaks can significantly disrupt economic activity and key societal functions. Agriculture has proven particularly vulnerable to disease-related disruptions, especially during labor-intensive operations like harvesting. The seasonal nature of agricultural labor can cause disease impacts to vary substantially across regions and crop cycles. Agricultural workers also face distinct health risks, with higher incidence of various diseases compared to the general population due to limited healthcare access, occupational exposures, and migration. Living conditions, particularly household crowding, can further increase infectious disease transmission risk among agricultural workers. 

Despite documented impacts of disease on agricultural systems, we lack predictive frameworks for anticipating how novel respiratory outbreaks might impact agricultural workers before outbreaks occur. The gap in disease incidence is poorly quantified and poorly resolved: we lack information on how ot translate community surveillance into information on agricultural workers, to support both public health interventions in a vulnerable population and to ensure successful food production. Furthermore, analytical frameworks for translating epidemiological impacts into impacts on agricultural productivity remain underdeveloped. [cite existing work here — including Jayson Lusk’s estimates of COVID impacts on agriculture] 

This study addresses these gaps by developing a disease transmission model specifically designed to anticipate the differential impacts of respiratory virus outbreaks on agricultural worerks relative to the general U.S. population. Focusing on household size and crowding – two well-established predictors of respiratory disease transmission – we quantify the relative rate of infections and assess potential impacts on harvesting operations. We apply this framework to three conimically important, labor-intensive crops with different harvest seasonalities: oranges, lettuce, and strawberries. Our analysis provides both a quantitative assessment of how outbreaks with varying characteristics might impact the agricultural sector and a generalizable framework for future assessments of disease impacts on agricultural production. 
## Methods
...
We obtained county-level data on population size, hohusehold size distribution, proportion of crowded households, and proportion of agricultural workers from the U.S. Census Bureau’s 2022 American Community Survey (ACS) 5-year estimates. Following standard definitions, we classified households as crowded when they contained more than one individual per room (excluding bathrooms, kitchens, and hallways). Agricultural workers were defined as individuals imployed in “farming, fishing, and forestry occupations” (ACS occupation codes). 
