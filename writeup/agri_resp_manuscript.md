...
We obtained weekly crop movement data for California strawberries, lettuce, and oranges from the USDA Agricultural Marketing Service, which serves as a proxy for harvest timing and volume [following ____]. We averaged movements across multiple years (2018-2024) to create representative seasonal patterns, then converted to daily estimates by dividing weekly volumes equally across days.
