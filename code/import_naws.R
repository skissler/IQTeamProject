# ==============================================================================
# import_naws.R - Import NAWS Data
# ==============================================================================
...
# D52 (number of people total sleeping in the housing unit)
# REGION6 (NAWS region)
# PWTYCRD (weight)
...
naws_data <- naws_hh %>%
  left_join(
    select(naws_crowding, REGION6, REGION_NAME, REGION_ABBREV, prop_crowded),
    by = c("REGION6", "REGION_NAME", "REGION_ABBREV")
  ) %>%
  ungroup()
